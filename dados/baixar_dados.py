...
def download_departamentos():
    ...
    if os.path.exists(file_name):
        ...
        url = 'https://dados.ufrn.br/dataset/da6451a5-1a59-4630-bdc2-97f6be4a59c2/resource/3f2e4e32-ef1a-4396-8037' \
...
def download_cursos():
    ...
    if os.path.exists(file_name):
        ...
        url = 'https://dados.ufrn.br/dataset/08b0dc59-faa9-4281-bd1e-2a39f532489e/resource/949be3d1-e85b-4d0f-9f60' \
...
def download_componentes():
    ...
    if os.path.exists(file_name):
        ...
        url = 'https://dados.ufrn.br/dataset/3fea67e8-6916-4ed0-aaa6-9a8ca06a9bdc/resource/9a3521d2-4bc5-4fda-93f0' \
...
def download_estruturas():
    ...
    if os.path.exists(file_name):
        ...
        url = 'https://dados.ufrn.br/dataset/e7c24910-75c1-451b-9097-e4352488dd69/resource/94cc35b0-6560-44f3-8c67' \
...
def download_curriculos():
    ...
    if os.path.exists(file_name):
        ...
        url = 'https://dados.ufrn.br/dataset/82aca3f1-f7ee-425e-bf1e-b6a1d6811bf4/resource/3f25d054-c5d2-4bf2-8cd4' \
...
def download_turmas():
    ...
    if os.path.exists(file_name):
        ...
        url = 'https://dados.ufrn.br/dataset/1938623d-fb07-41a4-a55a-1691f7c3b8b5/resource/1e42cd66-69d6-48d5-a346' \
    ...
    if os.path.exists(file_name):
        ...
        url = 'https://dados.ufrn.br/dataset/1938623d-fb07-41a4-a55a-1691f7c3b8b5/resource/d9c2863e-d1b2-4afd-b7dd' \
...
def download_docentes():
    ...
    if os.path.exists(file_name):
        ...
        print("Download do CSV dos Docentes do CERES/UFRN ...!")
        url = 'https://dados.ufrn.br/dataset/8bf1a468-48ff-4f4d-95ee-b17b7a3a5592/resource/ff0a457e-76fa-4aca-ad99' \
