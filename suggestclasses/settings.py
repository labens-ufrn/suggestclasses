"""
Django settings for suggestclasses project.
...
SESSION_COOKIE_AGE = config('SESSION_COOKIE_AGE', default=60 * 30, cast=int)
...
ROOT_URLCONF = 'suggestclasses.urls'
...
WSGI_APPLICATION = 'suggestclasses.wsgi.application'
